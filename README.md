...
### Улучшения страницы игры
 ...
 - [Содержимое окна договора скомпоновано в два столбца, а само окно договора уменьшено таким образом, чтобы при открытом договоре можно было общаться в чате (видно поле ввода и несколько строк чата). Также добавлена возможность уравнять договор путем добавления недостающей суммы.](assets/screenshots/features/trade.png)
 - [Кнопка постройки филиала продублирована рядом с каждым полем. Больше не нужно кликать на поле, чтобы построить филиал.](assets/screenshots/features/levelup-button.png)
